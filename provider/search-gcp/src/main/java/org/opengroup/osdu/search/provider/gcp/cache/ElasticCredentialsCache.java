...
public class ElasticCredentialsCache extends RedisCache<String, ClusterSettings> {
    ...
    public ElasticCredentialsCache(@Value("${REDIS_SEARCH_HOST}") final String REDIS_SEARCH_HOST, @Value("${REDIS_SEARCH_PORT}") final int REDIS_SEARCH_PORT, @Value("${ELASTIC_CACHE_EXPIRATION}") final int ELASTIC_CACHE_EXPIRATION) {
